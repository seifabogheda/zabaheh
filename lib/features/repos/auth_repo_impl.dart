...
class AuthRepoImpl extends BaseRepo{
  @override
  ...
  Future<bool> forgetPassword({required String phone}) async {
    ...
    var data = await DioHelper().post(url: AppStringsManager.forget, body: body);
    if (data["data"] == null) {
  ...
  Future<bool> resetPassword(String code, String password, String passwordConfirmation) async {
    Map<String, dynamic> body = {
      "code": code,
      "password": password,
      'password_confirmation': passwordConfirmation
    };
    var data = await DioHelper().post(url: AppStringsManager.resetPassword, body: body);
    if (data != null) {
  ...
  Future<bool> updatePassword(String oldPassword, String newPassword,String confirmNewPassword) async {
    Map<String, dynamic> body = {
      "old_password": oldPassword,
      "new_password": newPassword,
      "new_password_confirmation": confirmNewPassword,
    };
    var data = await DioHelper().post(url: AppStringsManager.changePassword, body: body);
    if (data != null) {
